...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md bg-primary p-6 rounded-xl shadow-lg space-y-6">
        <h1 className="text-2xl font-semibold text-center text-foreground">CalcIt</h1>

        <div>
          <label className="block text-sm font-medium mb-1 text-muted">Número</label>
          <Input
            type="number"
            placeholder="Ej: 100"
        ...
        <div>
          <label className="block text-sm font-medium mb-1 text-muted">Factor</label>
          <select
            value={factor}
            onChange={(e) =>
        ...
        <Button onClick={handleCopy} disabled={isCopied} className="w-full">
          {isCopied ? (
            <>
